...
| `speech_recognition`         | When data is being transferred between the client and server                      | [Speech Recognition Object](/javascript-sdk/reference/#onspeechdetected-json-response-example) |
| `message`                     | When the message object is detected.                                              | [Message Response Object](/javascript-sdk/reference/#onmessageresponse-json-response-example)                                                                                          |
| `topic`                       | When topics are detected.                                                         | [Topic Response Object](/javascript-sdk/reference/#ontopicresponse-json-response-example)                                                                                                          |
| `tracker`                     | When Trackers are detected.                                                       | [Tracker Response Object](/javascript-sdk/reference/#ontrackerresponse-json-response-example)                                                                                                       |
| `action_item`                | When Action Items are detected.                                                   | Action Item Response Object                                                                                         |
| `follow_up`                  | When follow-ups are detected.                                                     |  Follow Up Respone Object                                                                                                 |

...
```definitive``` | Boolean indicating if the action item is definitive or not. Explains the tone of the message. For e.g, ‘I will complete this task today’ is a definitive sentence. 

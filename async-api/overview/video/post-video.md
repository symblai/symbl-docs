...
HttpResponse<String> response = Unirest.post("https://api.symbl.ai/v1/process/video")
  .header("Content-Type", "video/mp4")
  .header("Authorization", "Bearar ACCESS_TOKEN")
...
var request = URLRequest(url: URL(string: "https://api.symbl.ai/v1/process/video")!,timeoutInterval: Double.infinity)
request.addValue("video/mp4", forHTTPHeaderField: "Content-Type")
request.addValue("Bearar ACCESS_TOKEN", forHTTPHeaderField: "Authorization")
...
var client = new RestClient("https://api.symbl.ai/v1/process/video");
client.Timeout = -1;
var request = new RestRequest(Method.POST);
request.AddHeader("Content-Type", "video/mp4");
request.AddHeader("Authorization", "Bearar ACCESS_TOKEN");
...
$request->setUrl('https://api.symbl.ai/v1/process/video');
...
url = URI("https://api.symbl.ai/v1/process/video")
...
request["Authorization"] = "Bearar ACCESS_TOKEN"
...
if(curl) {
  ...
  curl_easy_setopt(curl, CURLOPT_URL, "https://api.symbl.ai/v1/process/audio/url/conversationId");
...
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://api.symbl.ai/v1/process/audio/url/conversationId"]

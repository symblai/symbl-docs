...
HttpResponse<String> response = Unirest.post("https://api.symbl.ai/v1/process/video/url")
...
var request = URLRequest(url: URL(string: "https://api.symbl.ai/v1/process/video/url")!,timeoutInterval: Double.infinity)
...
var client = new RestClient("https://api.symbl.ai/v1/process/video/url");
client.Timeout = -1;
...
$request->setUrl('https://api.symbl.ai/v1/process/video/url');
...
url = URI("https://api.symbl.ai/v1/process/video/url")
...
if(curl) {
  ...
  curl_easy_setopt(curl, CURLOPT_URL, "https://api.symbl.ai/v1/process/video/url");
...
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://api.symbl.ai/v1/process/video/url"]

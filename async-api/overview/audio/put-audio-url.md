...
HttpResponse<String> response = Unirest.put("https://api.symbl.ai/v1/process/audio/url/CONVERSATION_ID_GOES_HERE")
...
var request = URLRequest(url: URL(string: "https://api.symbl.ai/v1/process/audio/url/CONVERSATION_ID_GOES_HERE")!,timeoutInterval: Double.infinity)
...
var client = new RestClient("https://api.symbl.ai/v1/process/audio/url/CONVERSATION_ID_GOES_HERE");
client.Timeout = -1;
...
$request->setUrl('https://api.symbl.ai/v1/process/audio/url/CONVERSATION_ID_GOES_HERE');
...
url = URI("https://api.symbl.ai/v1/process/audio/url/CONVERSATION_ID_GOES_HERE")
...
func main() {
  ...
  url := "https://api.symbl.ai/v1/process/audio/url/CONVERSATION_ID_GOES_HERE"
  method := "PUT"
...
if(curl) {
  ...
  curl_easy_setopt(curl, CURLOPT_URL, "https://api.symbl.ai/v1/process/audio/url/CONVERSATION_ID_GOES_HERE");
...
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://api.symbl.ai/v1/process/audio/url/CONVERSATION_ID_GOES_HERE"]

...
HttpResponse<String> response = Unirest.put("https://api.symbl.ai/v1/process/audio/{{conversationId}}")
...
var request = URLRequest(url: URL(string: "https://api.symbl.ai/v1/process/audio/{{conversationId}}")!,timeoutInterval: Double.infinity)
...
var client = new RestClient("https://api.symbl.ai/v1/process/audio/{{conversationId}}");
client.Timeout = -1;
var request = new RestRequest(Method.PUT);
request.AddHeader("Content-Type", "audio/mpeg");
request.AddHeader("Authorization", "Bearer ACCESS_TOKEN");
request.AddParameter("audio/mpeg", "<file contents here>", ParameterType.RequestBody);
...
$request->setUrl('https://api.symbl.ai/v1/process/audio/{{conversationId}}');
...
url = URI("https://api.symbl.ai/v1/process/audio/{{conversationId}}")
...
func main() {
  ...
  url := "https://api.symbl.ai/v1/process/audio/{{conversationId}}"
  method := "PUT"
...
if(curl) {
  ...
  curl_easy_setopt(curl, CURLOPT_URL, "https://api.symbl.ai/v1/process/audio/{{conversationId}}");
...
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://api.symbl.ai/v1/process/audio/{{conversationId}}"]

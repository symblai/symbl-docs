  ...
  const glossaryDictionary = {
    A: [
      ...
      },
      {
        ...
        description:
          "The Async Audio API allows you to process an audio file. It can be useful for any use case where you have access to recorded audio and want to extract insights and other conversational attributes supported by Symbl's Conversation API. To learn more, go ",
        url: "https://docs.symbl.ai/docs/async-api/introduction/#audio-api",
      },
    ],
    B: [
      {
    ...
    C: [
      ...
      },
      {
        ...
        description:
          "Conversational Analytics is an understanding of a conversation between two or more people to gain insights on the customer behavior. To learn more, go ",
        url: "https://docs.symbl.ai/docs/concepts/conversational-analytics/",
      },
      {
    ...
    P: [
      ...
      },
      {
        ...
        description:
          "The PSTN is a network that carries your calls when you dial in from a landline or cell phone. It refers to the worldwide network of voice-carrying telephone infrastructure, including privately-owned and government-owned infrastructure. To learn more, go ",
        url: "https://docs.symbl.ai/docs/concepts/pstn-and-sip/",
      },
    ],
    Q: [
      {
    ...
    S: [
      ...
      },
      {
        ...
        description: `The Async Audio & Async Video APIs can detect and separate unique speakers in a single stream of audio & video without need of separate speaker events. To learn more, go `,
        url: "https://docs.symbl.ai/docs/async-api/overview/speaker-separation/",
      },
      {
        title: "Summary UI",
      ...
      },
      {
        ...
        description:
          "The SIP is a standardized communications protocol that has been widely adopted for managing multimedia communication sessions for voice and video calls. SIP may be used to establish connectivity between your communications infrastructures and Symbl's communications platform. To learn more, go ",
        url: "https://docs.symbl.ai/docs/concepts/pstn-and-sip/",
      },
      {
      ...
      },
      {
        ...
        description:
          "This API allows you to get a Summary of important contextual messages in a conversation. Symbl's Conversational Intelligence distills important conversation messages and creates succinct Summaries. Summaries helps you save time required to grasp the contents of a conversation. Using Summary API, you can create Summaries in real-time or after the conversation has ended. You can also create Summaries for chat or email messages. To learn more, go ",
        url: "https://docs.symbl.ai/docs/concepts/summarization/",
      },
      {
        title: "Symbl Python SDK",
        description:
          "The Symbl Python SDK allows you to add Conversational Intelligence directly into your web applications and meeting platforms. You can generate Speech-to-Text and get intelligent insights such as action items, topics and questions, etc. To learn more, go ",
        url: "https://docs.symbl.ai/docs/python-sdk/overview/",
      },
    ],
    T: [
      {
    ...
    V: [
      {
        title: "Video API",
        description:
          "The Async Video API allows you to process a video file. It can be useful in any use case where you have access to a video file of any type of conversation, and you want to extract the insightful items supported by the Conversation API. To learn more, go ",
        url: "https://docs.symbl.ai/docs/async-api/introduction/#video-api",
      },
      {
        title: "Video Summary UI",
        description:
          "The Video Summary UI provides users the ability to interact with the Symbl elements(transcripts section, Insights, Filters) from an audio and video. It surfaces a screen where users can select key elements like topics, transcripts, and insights and the interface will surface the timestamp where this occurred and begin playback from there. To learn more, go ",
        url: "https://docs.symbl.ai/docs/pre-built-ui/summary-ui/#video-summary-ui",
      },
      {
        title: "VoIP",
        description:

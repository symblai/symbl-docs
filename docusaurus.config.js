...
module.exports = {
      ...
      "@docusaurus/plugin-client-redirects",
      {
        redirects: [
          ...
          },
          {
            ...
            from: ["/telephony/guides/connect-to-zoom-with-telephony-api"], // string | string[]
          },
          {
  ...
  themeConfig: {
    ...
    announcementBar: {
      ...
      content:
        "New Release Announcement: We have released the Symbl-Agora Marketplace extension with Agora SDK for Android applications. Head to our Integrations section to learn more.",
      backgroundColor: "#fafbfc", // Defaults to `#fff`.
      textColor: "#091E42", // Defaults to `#000`.
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: "GitHub",
              to: "https://github.com/symblai/symbl-docs",
            },
            {
              label: "Twitter",
              to: "https://twitter.com/symbldotai",
            },
            {
              label: "Linkedin",
              to: "https://www.linkedin.com/company/symbldotai/mycompany/",
            },
          ],
        },
      ],
